...
async function populateCollection() {
  try {
    ...
    const uri =
      "mongodb+srv://vercel-admin-user:h5h32CUHOASOwwk5@cluster0.1fu34kg.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
    ...
    const database = client.db("TipsyMenu");
    const collection =
